...
public class LanguageSamsul : MonoBehaviour
{
    public static LanguageSamsul instance = null;
        ...
        if (PlayerPrefs.GetInt(name + "Friendship") < 20)
        {
            ...
            if ((bool)PhotonNetwork.CurrentRoom.CustomProperties[name + "Jualan"])
            {
                ...
                if (answer == "yes")
                {
                    ...
                    GameObject.Find("Canvas").transform.Find("LivestockShop").gameObject.SetActive(true);
                    GameObject.Find("Canvas").transform.Find("DialogBG").gameObject.SetActive(false);
                    GameObject.Find("Canvas").transform.Find("UIkanan").gameObject.SetActive(true);
    ...
    public IEnumerator EndBuy()
    {
        ...
        for (int i = 0; i < GameObject.Find("Canvas").transform.Find("LivestockShop").Find("ScrollViewItem").GetChild(0).GetChild(0).childCount; i++)
            GameObject.Find("Canvas").transform.Find("LivestockShop").Find("ScrollViewItem").GetChild(0).GetChild(0).GetChild(i).Find("InputField").GetComponent<InputField>().text = "";
        for (int i = 0; i < GameObject.Find("Canvas").transform.Find("LivestockShop").Find("ScrollViewGoat").GetChild(0).GetChild(0).childCount; i++)
            GameObject.Find("Canvas").transform.Find("LivestockShop").Find("ScrollViewGoat").GetChild(0).GetChild(0).GetChild(i).Find("InputField").GetComponent<InputField>().text = "";
        for (int i = 0; i < GameObject.Find("Canvas").transform.Find("LivestockShop").Find("ScrollViewCow").GetChild(0).GetChild(0).childCount; i++)
            GameObject.Find("Canvas").transform.Find("LivestockShop").Find("ScrollViewCow").GetChild(0).GetChild(0).GetChild(i).Find("InputField").GetComponent<InputField>().text = "";
