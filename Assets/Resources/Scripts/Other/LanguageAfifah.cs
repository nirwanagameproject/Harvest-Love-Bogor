...
public class LanguageAfifah : MonoBehaviour
{
    public static LanguageAfifah instance = null;
    ...
    private void bahasa()
    {
        ...
        bahasaID.Add("K.k..k..kamu siapa ya ? Oh temennya kakak ya ? Salam kenal, Aku Afifah."); //0
        bahasaID.Add("Maaf kak, aku sedang buru-buru untuk sekolah. Lain kali saja ya kita ngobrolnya."); //1
        ...
        bahasaUS.Add("W..w.w.ho are you ? Ohh my brother's friend right ? Nice to meet you, I'm Afifah."); //0
        bahasaUS.Add("Excuse me, I'm in a hurry for school. Next time, let's talk about it."); //1
        ...
        bahasaJP.Add("あなたは誰 ？ああ、私の兄の友達でしょ？はじめまして、私はアフィファです。 "); //0
        bahasaJP.Add("すみません、学校に急いでいます。次回はそれについて話しましょう。"); //1
    ...
    public IEnumerator NPCMikaJalan()
    {
            ...
            PhotonNetwork.CurrentRoom.CustomProperties["hari"].ToString() != "Minggu")
        {
            ...
            GetComponent<NPC>().pos.x = 8.25f;
            GetComponent<NPC>().pos.y = 0;
            GetComponent<NPC>().pos.z = 17.63f;
            setProperti = new ExitGames.Client.Photon.Hashtable();
            setProperti.Add(name, "jalan1");
            PhotonNetwork.CurrentRoom.SetCustomProperties(setProperti);
            yield return new WaitUntil(() => PhotonNetwork.CurrentRoom.CustomProperties[name].ToString() == "jalan1");
            yield return new WaitForSeconds(1f);
            yield return new WaitUntil(() => PhotonNetwork.CurrentRoom.CustomProperties[name].ToString() == "");
            GetComponent<NPC>().pos.x = 14.31f;
            GetComponent<NPC>().pos.y = 0;
            GetComponent<NPC>().pos.z = 17.36f;
            setProperti = new ExitGames.Client.Photon.Hashtable();
            setProperti.Add(name, "jalan1");
            PhotonNetwork.CurrentRoom.SetCustomProperties(setProperti);
            yield return new WaitUntil(() => PhotonNetwork.CurrentRoom.CustomProperties[name].ToString() == "jalan1");
            yield return new WaitForSeconds(1f);
            yield return new WaitUntil(() => PhotonNetwork.CurrentRoom.CustomProperties[name].ToString() == "");
            GetComponent<NPC>().pos.x = 19.39f;
            GetComponent<NPC>().pos.y = 0;
            GetComponent<NPC>().pos.z = 22.86f;
            setProperti = new ExitGames.Client.Photon.Hashtable();
            setProperti.Add(name, "jalan1");
            PhotonNetwork.CurrentRoom.SetCustomProperties(setProperti);
            yield return new WaitUntil(() => PhotonNetwork.CurrentRoom.CustomProperties[name].ToString() == "jalan1");
            yield return new WaitForSeconds(1f);
            yield return new WaitUntil(() => PhotonNetwork.CurrentRoom.CustomProperties[name].ToString() == "");
            GetComponent<NPC>().pos.x = 18.75f;
            GetComponent<NPC>().pos.y = 0;
            GetComponent<NPC>().pos.z = 36.28f;
            setProperti = new ExitGames.Client.Photon.Hashtable();
            setProperti.Add(name, "jalan1");
            PhotonNetwork.CurrentRoom.SetCustomProperties(setProperti);
            yield return new WaitUntil(() => PhotonNetwork.CurrentRoom.CustomProperties[name].ToString() == "jalan1");
            ...
            transform.position = new Vector3(18.73f, 0, -0.89f);
            GetComponent<NPC>().pos.x = 28.31f;
            GetComponent<NPC>().pos.y = 0;
            GetComponent<NPC>().pos.z = 16.07f;
            setProperti = new ExitGames.Client.Photon.Hashtable();
            setProperti.Add(name, "jalan1");
            PhotonNetwork.CurrentRoom.SetCustomProperties(setProperti);
            yield return new WaitUntil(() => PhotonNetwork.CurrentRoom.CustomProperties[name].ToString() == "jalan1");
            yield return new WaitForSeconds(1f);
            yield return new WaitUntil(() => PhotonNetwork.CurrentRoom.CustomProperties[name].ToString() == "");
            GetComponent<NPC>().pos.x = 41.59f;
            GetComponent<NPC>().pos.y = 0;
            GetComponent<NPC>().pos.z = 9.71f;
            setProperti = new ExitGames.Client.Photon.Hashtable();
            setProperti.Add(name, "jalan1");
            PhotonNetwork.CurrentRoom.SetCustomProperties(setProperti);
            yield return new WaitUntil(() => PhotonNetwork.CurrentRoom.CustomProperties[name].ToString() == "jalan1");
            yield return new WaitForSeconds(1f);
            yield return new WaitUntil(() => PhotonNetwork.CurrentRoom.CustomProperties[name].ToString() == "");
            GetComponent<PhotonView>().RPC("gantiLevel", RpcTarget.All, "Invisible");

            //SELESAI SEKOLAH
            yield return new WaitUntil(() => int.Parse(PhotonNetwork.CurrentRoom.CustomProperties["jam"].ToString()) >= 16);
            GetComponent<PhotonView>().RPC("gantiLevel", RpcTarget.All, "Perkampungan_1");
            GetComponent<NPC>().pos.x = 28.31f;
            GetComponent<NPC>().pos.y = 0;
            GetComponent<NPC>().pos.z = 16.07f;
            ...
            yield return new WaitForSeconds(1f);
            yield return new WaitUntil(() => PhotonNetwork.CurrentRoom.CustomProperties[name].ToString() == "");
            GetComponent<NPC>().pos.x = 18.73f;
            GetComponent<NPC>().pos.y = 0;
            GetComponent<NPC>().pos.z = -0.89f;
            setProperti = new ExitGames.Client.Photon.Hashtable();
            setProperti.Add(name, "jalan1");
            PhotonNetwork.CurrentRoom.SetCustomProperties(setProperti);
            yield return new WaitUntil(() => PhotonNetwork.CurrentRoom.CustomProperties[name].ToString() == "jalan1");
            ...
            //PINDAH KE PERSIMPANGAN JALAN (PULANG SEKOLAH)
            GetComponent<PhotonView>().RPC("gantiLevel", RpcTarget.All, "PersimpanganJalan");
            transform.position = new Vector3(7.71f, 0, 25.04f);
            GetComponent<NPC>().pos.x = 8.037f;
            GetComponent<NPC>().pos.y = 0;
            GetComponent<NPC>().pos.z = -5.1f;
            setProperti = new ExitGames.Client.Photon.Hashtable();
            setProperti.Add(name, "jalan1");
            PhotonNetwork.CurrentRoom.SetCustomProperties(setProperti);
            yield return new WaitUntil(() => PhotonNetwork.CurrentRoom.CustomProperties[name].ToString() == "jalan1");
            ...
            //PINDAH KE PETERNAKAN (PULANG SEKOLAH)
            GetComponent<PhotonView>().RPC("gantiLevel", RpcTarget.All, "Peternakan");
            transform.position = new Vector3(18.75f, 0, 36.28f);
            GetComponent<NPC>().pos.x = 19.39f;
            GetComponent<NPC>().pos.y = 0;
            GetComponent<NPC>().pos.z = 22.86f;
            setProperti = new ExitGames.Client.Photon.Hashtable();
            ...
            GetComponent<NPC>().pos.x = 8.037f;
            GetComponent<NPC>().pos.y = 0;
            GetComponent<NPC>().pos.z = 20.119f;
            setProperti = new ExitGames.Client.Photon.Hashtable();
            setProperti.Add(name, "jalan1");
            PhotonNetwork.CurrentRoom.SetCustomProperties(setProperti);
            yield return new WaitUntil(() => PhotonNetwork.CurrentRoom.CustomProperties[name].ToString() == "jalan1");
            ...
            yield return new WaitForSeconds(1f);
            yield return new WaitUntil(() => PhotonNetwork.CurrentRoom.CustomProperties[name].ToString() == "");
            newMat = Resources.Load("Model/MainMenu/Material/" + name + "/BajuPulangSekolah", typeof(Material)) as Material;
            transform.GetChild(0).Find("Body").GetComponent<SkinnedMeshRenderer>().material = newMat;
