...
public class LanguageWindi : MonoBehaviour
{
    public static LanguageWindi instance = null;
    ...
    private void bahasa()
    {
        ...
        bahasaID.Add("Mau pesen apa kak? Ada sosis bakar, sate usus, tahu, tempe, nasi bakar dan lain-lain"); //0
        ...
        bahasaUS.Add("What do you want bro/sist? There are grilled sausages, intestine satay, tofu, tempe, grilled rice and others"); //0
        ...
        bahasaJP.Add("何をブロ/シストしたいですか？焼きソーセージ、腸サテ、豆腐、テンペ、焼きご飯などがあります"); //0
    ...
    public IEnumerator NPCMikaJalan()
    {
        ...
        //MASIH DI PASAR
        GetComponent<NPC>().pos.x = 34.3f;
        GetComponent<NPC>().pos.y = 0;
        GetComponent<NPC>().pos.z = 5.02f;
        ...
        yield return new WaitUntil(() => PhotonNetwork.CurrentRoom.CustomProperties[name].ToString() == "");
        GetComponent<NPC>().pos.x = 34.674f;
        GetComponent<NPC>().pos.y = 0;
        GetComponent<NPC>().pos.z = 7.128f;
        setProperti = new ExitGames.Client.Photon.Hashtable();
        setProperti.Add(name, "jalan1");
        PhotonNetwork.CurrentRoom.SetCustomProperties(setProperti);
        yield return new WaitUntil(() => PhotonNetwork.CurrentRoom.CustomProperties[name].ToString() == "jalan1");
        yield return new WaitForSeconds(1f);
        yield return new WaitUntil(() => PhotonNetwork.CurrentRoom.CustomProperties[name].ToString() == "");
        GetComponent<NPC>().pos.x = 35.171f;
        GetComponent<NPC>().pos.y = 0;
        GetComponent<NPC>().pos.z = 7.128f;
        setProperti = new ExitGames.Client.Photon.Hashtable();
        setProperti.Add(name, "jalan1");
        ...
        yield return new WaitForSeconds(5f);
        yield return new WaitUntil(() => PhotonNetwork.CurrentRoom.CustomProperties[name].ToString() == "");
        GetComponent<NPC>().pos.x = 34.17f;
        GetComponent<NPC>().pos.y = 0;
        GetComponent<NPC>().pos.z = 7.39f;
        setProperti = new ExitGames.Client.Photon.Hashtable();
        setProperti.Add(name, "jalan1");
        PhotonNetwork.CurrentRoom.SetCustomProperties(setProperti);
        yield return new WaitUntil(() => PhotonNetwork.CurrentRoom.CustomProperties[name].ToString() == "jalan1");
